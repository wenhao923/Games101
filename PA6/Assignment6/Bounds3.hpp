                                ...
                                const std::array<int, 3>& dirIsNeg) const
{
    ...
    float tX1=(pMin.x-ray.origin.x)*invDir.x;
    float tX2=(pMax.x-ray.origin.x)*invDir.x;
    float tY1=(pMin.y-ray.origin.y)*invDir.y;
    float tY2=(pMax.y-ray.origin.y)*invDir.y;
    float tZ1=(pMin.z-ray.origin.z)*invDir.z;
    float tZ2=(pMax.z-ray.origin.z)*invDir.z;
