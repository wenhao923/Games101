...
public:
    ...
    Intersection getIntersection(Ray ray)
    {
        ...
        //std::cout<<"计算mesh与ray相交"<<std::endl;
        if (bvh) {
...
inline Intersection Triangle::getIntersection(Ray ray)
{
    ...
    Vector3f E1=e1,E2=e2,S=ray.origin-v0,S1=crossProduct(ray.direction,E2),S2=crossProduct(S,E1);
    float t=1.0/dotProduct(S1,E1)*dotProduct(S2,E2);
    float b1=1.0/dotProduct(S1,E1)*dotProduct(S1,S);
    float b2=1.0/dotProduct(S1,E1)*dotProduct(S2,ray.direction);
    if (t>=0 && b1<=1&&b1>=0 && b2<=1&&b2>=0)
    {
        inter.happened=true;
        inter.distance=t;
        ray.t=t;
